#!/bin/bash
# Master 3-Terminal Project Shivodaya DTN Loop Agent Demonstration Runner
cd "$(dirname "$0")/../.."
...
echo "========================================================================="
echo "   PROJECT SHIVODAYA :: DTN BPv7 3-TERMINAL DEMONSTRATION SETUP "
echo "========================================================================="
echo ""
echo "This test demonstrates Project Shivodaya Store-and-Forward Custody Transfer:"
echo ""
...
echo "-------------------------------------------------------------------------"
echo "  Terminal 1: ./richa/ion_dtn_demo/terminal1sender.sh"
echo "  Terminal 2: ./richa/ion_dtn_demo/terminal2receiver.sh"
echo "  Terminal 3: ./richa/ion_dtn_demo/terminal3_delayed_receiver.sh"
echo "-------------------------------------------------------------------------"
echo ""
